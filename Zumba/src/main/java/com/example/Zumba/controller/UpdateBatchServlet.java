...
public class UpdateBatchServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        String sql = "UPDATE batches SET batch_name = ?, class_time = ? WHERE bid = ?";
        ...
        try (Connection conn = db.getConnection();
            ...
            pstmt.setString(2, classTime);  // The class_time parameter should be in 'YYYY-MM-DD HH:MM:SS' format
            pstmt.setInt(3, bid);
            ...
            if (rowsAffected > 0) {
                ...
                response.getWriter().write("Batch update failed. No rows affected.");
            }
